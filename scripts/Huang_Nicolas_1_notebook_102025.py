...
full = (
    web.merge(liaison[['ref_web_norm', 'ref_erp_norm']], how='left', on='ref_web_norm')
...
# Tableaux pour slides — noms produits
...
# Labels et titres avec noms produits
...
sns.heatmap(
    df[['price_num', 'purchase_price_num', 'stock_quantity_num', 'total_sales_value', 'margin_rate']].corr(),
